...
public class WB_PointMachine {

	public WB_PointMachine() {
	 ...
	 * @return 2D point
	 */
	public WB_Point createPointFromPolar2D(final double r, final double phi) {
	 ...
	 * @return 2D point
	 */
	public WB_Point createPointFromBipolar2D(final double a, final double sigma, final double tau) {
	 ...
	 * @return 2D point
	 */
	public WB_Point createPointFromParabolic2D(final double sigma, final double tau) {
	 ...
	 * @return 2D point
	 */
	public WB_Point createPointFromHyperbolic2D(final double u, final double v) {
	 ...
	 * @return 2D point
	 */
	public WB_Point createPointFromElliptic2D(final double a, final double sigma, final double tau) {
	 ...
	 * @return copy of point
	 */
	public WB_Point createPoint3D(final WB_Coord p) {
	 ...
	 * @return
	 */
	public WB_Point createPoint3D(final double[] p) {
		return new WB_Point(p);
	}
	 ...
	 * @return 2D point
	 */
	public WB_Point createPoint3D(final double _x, final double _y) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPoint3D(final double _x, final double _y, final double _z) {
	 ...
	 * @return
	 */
	public WB_Point createPoint3D(final Coordinate coord) {
		return createPoint3D(coord.x, coord.y);
	}
	 ...
	 * @return copy of point
	 */
	public WB_Point createInterpolatedPoint3D(final WB_Coord p, final WB_Coord q, final double f) {
		return new WB_Point((1.0 - f) * p.xd() + f * q.xd(), (1.0 - f) * p.yd() + f * q.yd(),
				(1.0 - f) * p.zd() + f * q.zd());
	}
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromCylindrical3D(final double r, final double phi, final double z) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromSpherical3D(final double r, final double theta, final double phi) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromParaboloidal3D(final double sigma, final double tau, final double phi) {
		return createPoint3D(sigma * tau * Math.cos(phi), sigma * tau * Math.sin(phi), 0.5 * (tau * tau - sigma * sigma));
	}
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromParabolic3D(final double sigma, final double tau, final double z) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromOblateSpheroidal3D(final double a, final double mu, final double nu,
			final double phi) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromProlateSpheroidal3D(final double a, final double mu, final double nu,
			final double phi) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromEllipsoidal3D(final double a, final double b, final double c, final double lambda,
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromElliptic3D(final double a, final double mu, final double nu, final double z) {
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromToroidal3D(final double a, final double sigma, final double tau, final double phi) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromBispherical3D(final double a, final double sigma, final double tau, final double phi) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromBipolarCylindrical3D(final double a, final double sigma, final double tau,
			final double z) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D point
	 */
	public WB_Point createPointFromConical3D(final double b, final double c, final double r, final double mu,
			final double nu) {
		final double b2 = b * b;
		final double c2 = c * c;
