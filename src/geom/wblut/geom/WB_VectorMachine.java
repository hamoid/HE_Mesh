...
public class WB_VectorMachine {

	public WB_VectorMachine() {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVectorFromPolar2D(final double r, final double phi) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVectorFromBipolar2D(final double a, final double sigma, final double tau) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVectorFromParabolic2D(final double sigma, final double tau) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVectorFromHyperbolic2D(final double u, final double v) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVectorFromElliptic2D(final double a, final double mu, final double nu) {
	 ...
	 * @return zero-length vector
	 */
	public WB_Vector createVector3D() {
	 ...
	 * @return
	 */
	public WB_Vector createVectorFromTo3D(final WB_Coord p, final WB_Coord q) {
	 ...
	 * @return vector
	 */
	public final WB_Vector createVector3D(final WB_Coord p) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createVector3D(final double _x, final double _y) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVector3D(final double _x, final double _y, final double _z) {
	 ...
	 * @return
	 */
	public WB_Vector createNormalizedVector3D(final WB_Coord p) {
	 ...
	 * @return
	 */
	public WB_Vector createNormalizedVectorFromTo3D(final WB_Coord p, final WB_Coord q) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createNormalizedVector3D(final double _x, final double _y, final double _z) {
	 ...
	 * @return
	 */
	public WB_Vector createNormalizedVector3D(final double _x, final double _y, final double _z, final double _w) {
		final WB_Vector vec = createVector3D(_x, _y, _z);
		vec.normalizeSelf();
		return vec;
	}

	public WB_Vector createNormalizedVector3D(final double _x, final double _y) {
	 ...
	 * @return 2D vector
	 */
	public WB_Vector createNormalizedPerpendicularVector3D(final double _x, final double _y) {
	 ...
	 * @return
	 */
	public WB_Vector createNormalizedPerpendicularVector3D(final double _x, final double _y, final double _z) {
		if (_x > _y) {
			if (_y > _z) {
	 ...
	 * @return
	 */
	public WB_Vector createNormalizedPerpendicularVector3D(final WB_Coord p) {
		if (p.xd() > p.yd()) {
			if (p.yd() > p.zd()) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromCylindrical3D(final double r, final double phi, final double z) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromSpherical3D(final double r, final double theta, final double phi) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromParaboloidal3D(final double sigma, final double tau, final double phi) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromParabolic3D(final double sigma, final double tau, final double z) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromOblateSpheroidal3D(final double a, final double mu, final double nu,
			final double phi) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromProlateSpheroidal3D(final double a, final double mu, final double nu,
			final double phi) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromEllipsoidal3D(final double a, final double b, final double c, final double lambda,
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromElliptic3D(final double a, final double mu, final double nu, final double z) {
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromToroidal3D(final double a, final double sigma, final double tau, final double phi) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromBispherical3D(final double a, final double sigma, final double tau,
			final double phi) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromBipolarCylindrical3D(final double a, final double sigma, final double tau,
			final double z) {
		double invdenom = Math.cosh(tau) - Math.cos(sigma);
		invdenom = WB_Epsilon.isZero(invdenom) ? 0.0 : a / invdenom;
	 ...
	 * @return 3D vector
	 */
	public WB_Vector createVectorFromConical3D(final double b, final double c, final double r, final double mu,
			final double nu) {
		final double b2 = b * b;
		final double c2 = c * c;
